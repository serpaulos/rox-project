from sqlalchemy import (create_engine, exc, MetaData, Table, Column, Integer, String, Float, TEXT, TIMESTAMP ,ForeignKeyConstraint)
import config
...
person_table = Table('person_table', metadata,
    ...
    Column('AdditionalContactInfo',    String(100)),
    Column('Demographics',             String(100)),
